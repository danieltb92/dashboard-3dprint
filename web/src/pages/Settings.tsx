...
import { Settings as SettingsIcon, Save, Loader2, Zap, Percent, DollarSign, TrendingUp } from 'lucide-react';
...
const SETTING_DEFINITIONS = [
  { key: 'cop_kwh', label: 'Costo por kWh (COP)', icon: Zap, description: 'Tarifa de energía eléctrica en pesos colombianos', type: 'number' },
  { key: 'iva_pct', label: 'IVA (%)', icon: Percent, description: 'Porcentaje de IVA para cotizaciones', type: 'number' },
  { key: 'labor_rate_cop', label: 'Tarifa mano de obra (COP/hora)', icon: DollarSign, description: 'Costo por hora de trabajo', type: 'number' },
  { key: 'margen_default', label: 'Margen por defecto (%)', icon: TrendingUp, description: 'Margen de ganancia aplicado al precio de venta', type: 'number' },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {SETTING_DEFINITIONS.map(({ key, label, icon: Icon, description, type }) => (
